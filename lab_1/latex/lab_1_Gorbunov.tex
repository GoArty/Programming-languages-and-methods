...
Установить IntelliJ IDEA. Установка Java Development Kit (JDK). Создание проекта и класса Factorial. Запуск программы.  
...
\begin{figure}[!htb]
\begin{lstlisting}[language={},caption={класс Factorial},label={lst:code1}]
...
\caption{Работа программы в IntelliJ IDEA}
...
\caption{Работа программы в консоле(Windows)}
